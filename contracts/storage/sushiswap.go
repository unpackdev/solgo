...
var SushiSwap = []*Storage{
	{
		...
		Sources: &solgo.Sources{
			EntrySourceUnitName: "UniswapV2Router02",
			SourceUnits: []*solgo.SourceUnit{
				{
					Name: "UniswapV2Router02",
					Path: "UniswapV2Router02.sol",
	...
	},
	{
		...
		EvmVersion:       "istanbul",
		Sources: &solgo.Sources{
			EntrySourceUnitName: "UniswapV2Factory",
			SourceUnits: []*solgo.SourceUnit{
				{
					Name: "UniswapV2Factory",
					Path: "UniswapV2Factory.sol",
					Content: `// SPDX-License-Identifier: GPL-3.0-or-later
				   pragma solidity >=0.5.0;
...
func init() {
	for _, entry := range SushiSwap {
		if err := RegisterStorage(entry); err != nil {
			zap.L().Fatal(
				"failed to register sushiswap contract to storage",
				zap.Error(err),
