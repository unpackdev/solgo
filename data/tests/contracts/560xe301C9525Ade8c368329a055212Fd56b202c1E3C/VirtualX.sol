...
contract VirtualX is ERC20BurnableUpgradeable, OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    function initialize(address _liquidity, address _presale)
        external
        initializer
    {
        __ERC20_init("VirtualX", "VRL");
        __ERC20Burnable_init();
        __Ownable_init();
        _mint(_presale, 7e27); //7 billion
        _mint(_liquidity, 93e27); //100 billion
    }
